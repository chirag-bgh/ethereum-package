...
def input_parser(plan, input_args):
    ...
    return struct(
        ...
        mev_params=struct(
            ...
            helix_trusted_builder_pubkey=result["mev_params"]["helix_trusted_builder_pubkey"],
            helix_builder_api_key=result["mev_params"]["helix_builder_api_key"],
...
def get_default_mev_params(mev_type, preset):
    ...
    helix_trusted_builder_pubkey = constants.DEFAULT_MEV_PUBKEY
    helix_builder_api_key = constants.DEFAULT_HELIX_BUILDER_API_KEY
